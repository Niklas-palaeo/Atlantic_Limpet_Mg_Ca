...
#| fig-cap: Isotope values of Patella vulagata limpet shells from Quoygrew (QG, *a-g*) and Rack Wick Bay (ORK, *h*) on Westray, Orkney.
#| fig-height: 10
#| fig-width: 10
#| label: fig-Pat_iso
# Filter data for Modern period
