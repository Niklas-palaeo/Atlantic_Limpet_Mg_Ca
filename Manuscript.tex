...
channel waters are predominantly influenced by marine currents stayed
...
experiences virtually no freshwater input. The annual SST ranges from
6.3ºC in March to 13.8ºC in August (Figure~\ref{fig-SSTs}).
